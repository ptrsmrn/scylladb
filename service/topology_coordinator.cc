...
//                    auto new_tablet_map = ret.new_tablet_map;
//                    auto status = ret.status;
//
//                    for (auto [dc_name, dc_status] : status) {
//                        for (auto sss: dc_status) {
//                            if (sss != tablet_reallocation_status::success) {
//                                rtlogger.info("smaron status {}:{}", dc_name, (int) sss);
//                                throw std::runtime_error("smaron tablet_reallocation_status failure");
//                            }
//                        }
//                    }
