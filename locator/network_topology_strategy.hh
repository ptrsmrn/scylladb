...
private:
    ...
    future<tablet_replica_set> add_tablets_in_dc(schema_ptr, const locator::topology&, load_sketch&,
    ...
    tablet_replica_set drop_tablets_in_dc(schema_ptr, const locator::topology&,
            const tablet_replica_set& cur_replicas,
            sstring dc, size_t dc_node_count, size_t dc_rf) const;
